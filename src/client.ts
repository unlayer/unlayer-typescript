...
export interface ClientOptions {
   ...
   * Set the log level.
   *
   * Defaults to process.env['UNLAYER_LOG'] or 'warn' if it isn't set.
   */
...
export class Unlayer {
  ...
  constructor({
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('UNLAYER_LOG'), "process.env['UNLAYER_LOG']", this) ??
      defaultLogLevel;
  ...
  static UnlayerError = Errors.UnlayerError;
